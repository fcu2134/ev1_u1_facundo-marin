...
namespace ev1_u1.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdServicio,Tipo,Disponibilidad,Precios,Estado,Comentarios")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdServicio,Tipo,Disponibilidad,Precios,Estado,Comentarios")] Servicio servicio)
        {
